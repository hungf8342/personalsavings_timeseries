...
And here are the parameters for the multiplicative seasonal model. Given these parameters, the seasonal model is given by $(Y_t-6.28)(1-.861(B-6.28))(1+.228(B-6.28)^4) = e_t$
